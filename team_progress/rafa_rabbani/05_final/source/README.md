...
| Nama | Fokus |
| --- | --- |
| Fatir Zaidan | Gameplay utama Mario, campaign, quest, checkpoint, dan integrasi akhir |
| Ghazi | Launcher Tkinter, audio, inventory, aset UI, dependency, dan testing setting |
| Kala | Engine dan desain level, balancing koin/enemy, aset title screen, dan testing level |
| Rafa Rabbani | Shop helper, dokumentasi, aset karakter/item, panduan kontrol, dan bahan presentasi |

File progress per anggota tersedia di folder `team_progress/`, dengan pembagian
enam file untuk setiap anggota.
